...
#' \item{Sigma1}{predicted correlation matrix under the alternative hypothesis with each row and column following the test statistics corresponding to \code{index}. }
